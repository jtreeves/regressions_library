...
from .inverse import inverse, inverse_3d, inverse_all
...
print(f'Inverse Reg: {inverse_output}') # => [[-3, 8], [2, -5]]
print(f'Inverse All: {inverse_all_output}') # => [[-3, 8], [2, -5]]
print(f'Determinant 3x3: {determinant_output_3d}') # => -306
print(f'3-D Inverse Reg: {inverse_output_3d}') # => [[0.2, 0.2, 0], [-0.2, 0.3, 1], [0.2, -0.3, 0]]
print(f'3-D Inverse All: {inverse_all_output_3d}') # => [[0.2, 0.2, 0], [-0.2, 0.3, 1], [0.2, -0.3, 0]]
