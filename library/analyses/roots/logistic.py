...
def logistic_roots_initial_value(first_constant, second_constant, third_constant, intial_value, precision = 4):
...
def logistic_roots_derivative_initial_value(first_constant, second_constant, third_constant, intial_value, precision = 4):
