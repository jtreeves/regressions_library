...
def cubic_roots_initial_value(first_constant, second_constant, third_constant, fourth_constant, intial_value, precision = 4):
    roots = cubic_roots(first_constant, second_constant, third_constant, fourth_constant - intial_value, precision)
    return roots

def cubic_roots_derivative_initial_value(first_constant, second_constant, third_constant, fourth_constant, intial_value, precision = 4):
