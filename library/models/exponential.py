...
def exponential_model(data, precision):
    ...
    model['averages']['range']['average_value_integral'] : float
        Average value of the curve represented by the exponential model between the smallest independent coordinate originally provided and the largest independent coordinate originally provided (see `Mean Value Theorem for Integrals <https://tutorial.math.lamar.edu/classes/calci/avgfcnvalue.aspx>`_)
    ...
    model['averages']['iqr']['average_value_derivative'] : float
        Average rate of change of the curve represented by the exponential model between the first and third quartiles of all the independent coordinates originally provided (see `Mean Value Theorem for Derivatives <https://tutorial.math.lamar.edu/classes/calci/MeanValueTheorem.aspx>`_)
    ...
    model['averages']['iqr']['average_value_integral'] : float
        Average value of the curve represented by the exponential model between the first and third quartiles of all the independent coordinates originally provided (see `Mean Value Theorem for Integrals <https://tutorial.math.lamar.edu/classes/calci/avgfcnvalue.aspx>`_)
