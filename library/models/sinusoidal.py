...
print(test_run)
# {'constants': [-5.0, 1.5708, 3.0, 3.0], 'evaluations': {'equation': <function sinusoidal.<locals>.sinusoidal_equation at 0x10bdf68b0>, 'derivative': <function sinusoidal.<locals>.first_derivative at 0x10bdf69d0>, 'integral': <function sinusoidal.<locals>.sinusoidal_integral at 0x10bdf6a60>}, 'points': {'roots': [[3.4097, 0], [4.5903, 0], [7.4097, 0], [8.5903, 0], [11.4097, 0], [12.5903, 0], ['3.4097 + 4.0k', 0], ['4.5903 + 4.0k', 0]], 'maxima': [[6.0, 8.0], [10.0, 8.0]], 'minima': [[4.0, -2.0], [8.0, -2.0], [12.0, -2.0]], 'inflections': [[3.0, 3.0], [5.0, 3.0], [7.0, 3.0], [9.0, 3.0], [11.0, 3.0]]}, 'accumulations': {'range': 30.1831, 'iqr': 11.8169}, 'averages': {'range': {'average_value_derivative': 0.5556, 'mean_values_derivative': [3.9549, 4.0451, 7.9549, 8.0451, '4.0451 + 4.0k', '3.9549 + 4.0k'], 'average_value_integral': 3.3537, 'mean_values_integral': [2.9549, 5.0451, 6.9549, 9.0451, '2.9549 + 4.0k', '5.0451 + 4.0k']}, 'iqr': {'average_value_derivative': -1.0, 'mean_values_derivative': [3.9187, 4.0813, 7.9187, '3.9187 + 4.0k', '4.0813 + 4.0k'], 'average_value_integral': 2.3634, 'mean_values_integral': [3.0813, 4.9187, 7.0813, '3.0813 + 4.0k', '4.9187 + 4.0k']}}, 'correlation': 1.0}