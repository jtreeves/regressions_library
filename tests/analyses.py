...
linear_intercepts = intercepts('linear', coefficients[:2])
...
linear_extrema = extrema('linear', coefficients[:2], linear_derivatives_object['first']['evaluation'])
quadratic_extrema = extrema('quadratic', coefficients[:3], quadratic_derivatives_object['first']['evaluation'])
cubic_extrema = extrema('cubic', coefficients, cubic_derivatives_object['first']['evaluation'])
hyperbolic_extrema = extrema('hyperbolic', coefficients[:2], hyperbolic_derivatives_object['first']['evaluation'])
exponential_extrema = extrema('exponential', coefficients[:2], exponential_derivatives_object['first']['evaluation'])
logarithmic_extrema = extrema('logarithmic', coefficients[:2], logarithmic_derivatives_object['first']['evaluation'])

linear_inflections = inflections('linear', coefficients[:2], linear_derivatives_object['second']['evaluation'])
quadratic_inflections = inflections('quadratic', coefficients[:3], quadratic_derivatives_object['second']['evaluation'])
cubic_inflections = inflections('cubic', coefficients, cubic_derivatives_object['second']['evaluation'])
hyperbolic_inflections = inflections('hyperbolic', coefficients[:2], hyperbolic_derivatives_object['second']['evaluation'])
exponential_inflections = inflections('exponential', coefficients[:2], exponential_derivatives_object['second']['evaluation'])
logarithmic_inflections = inflections('logarithmic', coefficients[:2], logarithmic_derivatives_object['second']['evaluation'])

linear_key_points = key_points('linear', coefficients[:2], linear_function, linear_derivatives_object['first']['evaluation'], linear_derivatives_object['second']['evaluation'])
quadratic_key_points = key_points('quadratic', coefficients[:3], quadratic_function, quadratic_derivatives_object['first']['evaluation'], quadratic_derivatives_object['second']['evaluation'])
...
hyperbolic_key_points = key_points('hyperbolic', coefficients[:2], hyperbolic_function, hyperbolic_derivatives_object['first']['evaluation'], hyperbolic_derivatives_object['second']['evaluation'])
exponential_key_points = key_points('exponential', coefficients[:2], exponential_function, exponential_derivatives_object['first']['evaluation'], exponential_derivatives_object['second']['evaluation'])
logarithmic_key_points = key_points('logarithmic', coefficients[:2], logarithmic_function, logarithmic_derivatives_object['first']['evaluation'], logarithmic_derivatives_object['second']['evaluation'])
