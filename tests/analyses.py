...
print(f'FIRST HYPERBOLIC CRITICAL POINTS: {first_hyperbolic_critical_points}') # [0]
...
print(f'SECOND HYPERBOLIC CRITICAL POINTS: {second_hyperbolic_critical_points}') # [0]
...
print(f'FIRST HYPERBOLIC INTERVALS: {first_hyperbolic_intervals}') # ['negative', 0, 'negative']
...
print(f'SECOND HYPERBOLIC INTERVALS: {second_hyperbolic_intervals}') # ['negative', 0, 'positive']
