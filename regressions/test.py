...
print(f"Sinusoidal Error: {cyclic_solution['error']}") # => NOT SURE WHAT I SHOULD HAVE EXPECTED, BUT I GOT: 69.6112 // NEW ERROR: 258.3859834434484 // NEWER ERROR: 214.2937082641205 // ERROR AFTER AVERAGING A & B: 34.296893836130046 // AFTER AVERAGING C TOO: 31.688095114749128
