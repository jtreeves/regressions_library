...
print(f"Sinusoidal Constants: {cyclic_solution['constants']}") # => [[28.2382], [0.5236], [-1.8948], [53.5833]] // VERSUS WHAT I GOT: [[1126.9119], [1.1709], [-2.1711], [1290.0787]] // NEW VALUES: [[-22022.99146071105], [0.6013015109266755], [0.6276552476317352], [13293.135715281009]] // NEWER VALUES: [[15430.83920235599], [0.6013015109266755], [0.6276552476317352], [-8701.570750628009]]
print(f"Sinusoidal Error: {cyclic_solution['error']}") # => NOT SURE WHAT I SHOULD HAVE EXPECTED, BUT I GOT: 69.6112 // NEW ERROR: 258.3859834434484 // NEWER ERROR: 214.2937082641205
